...
case 'kisahnabi':
        if (isBanned)return reply(mess.ban)
				reply(mess.wait)
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://hardianto.xyz/docs/muslim/kisahnabi?nabi=${query}&apikey=hardianto`)
...
case 'spongebobm':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  hehe = await getBuffer(`https://hardianto.xyz/docs/knights/spongebob?apikey=hardianto&pp=${anu.display_url}`)
...
case 'hengkerm':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  tels = body.slice(7)
	  anu = await imgbb("520bd6f6209077d1777c2a4f20c509c2", owgi)
	  hehe = await getBuffer(`https://hardianto.xyz/docs/beta/hacker2?apikey=hardianto&pp=${anu.display_url}`)
	 syaa.sendMessage(from, hehe, image, {quoted:mek})
	} else {
	  reply('Foto Nya Mana Gan 🗿')
	}
...
case 'hengkerm2':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  tels = body.slice(7)
	  anu = await imgbb("520bd6f6209077d1777c2a4f20c509c2", owgi)
	  hehe = await getBuffer(`https://hardianto.xyz/docs/beta/hacker3?apikey=hardianto&pp=${anu.display_url}`)
	 syaa.sendMessage(from, hehe, image, {quoted:mek})
	} else {
	  reply('Foto Nya Mana Gan 🗿')
	}
...
case 'ripm':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  tels = body.slice(7)
	  anu = await imgbb("520bd6f6209077d1777c2a4f20c509c2", owgi)
	  hehe = await getBuffer(`https://hardianto.xyz/docs/rip?image=${anu.display_url}&apikey=hardianto`)
	 syaa.sendMessage(from, hehe, image, {quoted:mek})
	} else {
	  reply('Foto Nya Mana Gan 🗿')
	}
...
case 'stonkm':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  tels = body.slice(7)
	  anu = await imgbb("520bd6f6209077d1777c2a4f20c509c2", owgi)
	  hehe = await getBuffer(`https://hardianto.xyz/docs/stonk?image=${anu.display_url}&apikey=hardianto`)
	 syaa.sendMessage(from, hehe, image, {quoted:mek})
	} else {
	  reply('Foto Nya Mana Gan 🗿')
	}
...
case 'notstonkm':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  tels = body.slice(7)
	  anu = await imgbb("520bd6f6209077d1777c2a4f20c509c2", owgi)
	  hehe = await getBuffer(`https://hardianto.xyz/docs/not-stonk?image=${anu.display_url}&apikey=hardianto`)
	 syaa.sendMessage(from, hehe, image, {quoted:mek})
	} else {
	  reply('Foto Nya Mana Gan 🗿')
	}
...
case 'patrickm':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  tels = body.slice(7)
	  anu = await imgbb("520bd6f6209077d1777c2a4f20c509c2", owgi)
	  hehe = await getBuffer(`https://hardianto.xyz/docs/knights/patrick?apikey=hardianto&pp=${anu.display_url}`)
	 syaa.sendMessage(from, hehe, image, {quoted:mek})
	} else {
	  reply('Foto Nya Mana Gan 🗿')
	}
...
reply(mess.wait)
budi = body.slice(8)
kon = (`https://hardianto.xyz/docs/photooxy/naruto?apikey=hardianto&text=${budi}`)
...
case "attp"://Ini lu fix in sendiri aja
  if (!isBanned)return reply("Maaf Fitur ttp & attp sedang  errorr, mungkin karena dari website/rest api")
					...
					biji = body.slice(6)
					atetepe = await getBuffer(`https://hardianto.xyz/docs/maker/attp?text=${biji}&apikey=hardianto`)
...
case "ttpyellow":
  ...
  if (isBanned) return reply(mess.ban)
					if (args.length < 1) return reply('Teksnya?')
					biji = body.slice(11)
					atetepe = await getBuffer(`https://hardianto.xyz/docs/ttpcustom?text=${biji}&color=yellow&apikey=hardianto`)
					syaa.sendMessage(from, atetepe, sticker, { quoted: mek })
					break
case "ttpgreen":
  if (!isBanned)return reply("Maaf Fitur ttp & attp sedang  errorr, mungkin karena dari website/rest api")
  ...
  if (isBanned) return reply(mess.ban)
					if (args.length < 1) return reply('Teksnya?')
					biji = body.slice(10)
					atetepe = await getBuffer(`https://hardianto.xyz/docs/ttpcustom?text=${biji}&color=green&apikey=hardianto`)
					syaa.sendMessage(from, atetepe, sticker, { quoted: mek })
					break
case "ttpblue":
  if (!isBanned)return reply("Maaf Fitur ttp & attp sedang  errorr, mungkin karena dari website/rest api")
  ...
  if (isBanned) return reply(mess.ban)
					if (args.length < 1) return reply('Teksnya?')
					biji = body.slice(9)
					atetepe = await getBuffer(`https://hardianto.xyz/docs/ttpcustom?text=${biji}&color=blue&apikey=hardianto`)
					syaa.sendMessage(from, atetepe, sticker, { quoted: mek })
					break
case "ttp":
  if (!isBanned)return reply("Maaf Fitur ttp & attp sedang  errorr, mungkin karena dari website/rest api")
  ...
  if (isBanned) return reply(mess.ban)
					if (args.length < 1) return reply('Teksnya?')
					biji = body.slice(5)
					atetepe = await getBuffer(`https://hardianto.xyz/docs/ttpcustom?text=${biji}&color=brown&apikey=hardianto`)
					syaa.sendMessage(from, atetepe, sticker, { quoted: mek })
					break
case "kiss":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
  if (isBanned) return reply(mess.ban)
					atetepe = await getBuffer(`https://hardianto.xyz/docs/anime/random?sfw=kiss&apikey=hardianto`)
					syaa.sendMessage(from, atetepe, sticker, { quoted: mek })
					break
case "halloween":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
...
case "blowjob":
  ...
  if (isBanned) return reply(mess.ban)
  reply(mess.wait)
					atetepe = await getBuffer(`https://hardianto.xyz/docs/anime/random?nsfw=blowJob&apikey=hardianto`)
					syaa.sendMessage(from, atetepe, image, { quoted: mek })
					break
case "hentai":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
...
case "avatar":
  ...
  if (!isNsfw) return reply(mess.nsfw)
  reply(mess.wait)
					atetepe = await getBuffer(`https://hardianto.xyz/docs/anime/random?nsfw=avatar&apikey=hardianto`)
					syaa.sendMessage(from, atetepe, image, { quoted: mek })
					break
case "trap":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
  ...
  if (!isNsfw) return reply(mess.nsfw)
  reply(mess.wait)
					atetepe = await getBuffer(`https://hardianto.xyz/docs/anime/random?nsfw=trap&apikey=hardianto`)
					syaa.sendMessage(from, atetepe, image, { quoted: mek })
					break
////AKHIR NSFW
case "tebakgambar":
...
case "waifum":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
     ...
     memek1 = ct.split("|")[0];
     memek2 = ct.split("|")[1];
     anu = await fetchJson(`https://hardianto.xyz/docs/bot/gfx4?apikey=hardianto&text1=${memek1}&text2=${memek2}`)
     buffer = await getBuffer(anu.result.url)
     syaa.sendMessage(from, buffer, image, {quoted: mek, caption: 'nih kack'})
     break
case "ctahta":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
     ...
     memek2 = ct.split("|")[1];
     memek3 = ct.split("|")[2];
     anu = await fetchJson(`https://hardianto.xyz/docs/customtahta?query=${memek1}\n${memek2}\n${memek3}&apikey=hardianto`)
     buffer = await getBuffer(anu.result.url)
     syaa.sendMessage(from, buffer, image, {quoted: mek, caption: 'nih kack'})
     break
case 'stcmeme':
...
⚖️ Durasi : ${res[0].size}`
      ...
      case "instagram":
        ...
        case 'tiktok': {
                ...
                try {
                reply(mess.wait)
                var data = await fetchJson(`https://hardianto.xyz/docs/download/tiktok?url=${args[1]}&apikey=hardianto`)
...
break
        ...
        rakz = await getBuffer(
          `https://hardianto.xyz/docs/nuliskiri?text=${bodi}&apikey=hardianto`
        );
        ...
        reply("Sedang Menulis....");
        rakz = await getBuffer(
          `https://hardianto.xyz/docs/nuliskanan?text=${bodi}&apikey=hardianto`
        );
        syaa.sendMessage(from, rakz, image, {
          quoted: mek,
          thumbnail: Buffer.alloc(0),
        ...
        reply("Sedang Menulis....");
        rakz = await getBuffer(
          `https://hardianto.xyz/docs/foliokiri?text=${bodi}&apikey=hardianto`
        );
        syaa.sendMessage(from, rakz, image, {
          quoted: mek,
          thumbnail: Buffer.alloc(0),
        ...
        reply("Sedang Menulis....");
        rakz = await getBuffer(
          `https://hardianto.xyz/docs/foliokanan?text=${bodi}&apikey=hardianto`
        );
        syaa.sendMessage(from, rakz, image, {
          quoted: mek,
          thumbnail: Buffer.alloc(0),
...
case "remm":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
   ...
   sendMediaURL(from, `https://hardianto.xyz/docs/bot/gfx5?apikey=hardianto&text=${bapakao}`)
   break
case "logogaming":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
   if (args.length < 1) return reply(from, `Penggunaan ${prefix + command} teks`, mek)
...
case "lolim":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
   ...
   sendMediaURL(from, `https://hardianto.xyz/docs/bot/gfx2?apikey=hardianto&nama=${bapakao}`)
   break
case "kaneki":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
  if (isBanned) return reply(mess.ban)
   ...
   sendMediaURL(from, `https://hardianto.xyz/docs/bot/gfx1?apikey=hardianto&nama=${bapakao}`)
   break
case "gura":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
   ...
   reply(mess.wait)
   bapakao = body.slice(6)
   sendMediaURL(from, `https://hardianto.xyz/docs/bot/gura?apikey=hardianto&nama=${bapakao}`)
   break
case "neko":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
   if (isBanned) return reply(mess.ban)
   bapakao = body.slice(9)
   sendMediaURL(from, `https://hardianto.xyz/docs/anime/random?sfw=neko&apikey=hardianto`)
   break
case "bajingan":
     if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
   ...
   sendStickerFromUrl(from, `https://hardianto.xyz/docs/creator/memegen?bawah=${bapakao}&atas=bajingan&imgurl=https://telegra.ph/file/d608ec3cb57ff6b9ac708.jpg&apikey=hardianto`)
...
case "darkjokes":
  case "darkjoke":
   ...
   if (isBanned) return reply(mess.ban)
   bapakao = body.slice(9)
   sendMediaURL(from, `https://hardianto.xyz/docs/darkmeme?apikey=hardianto`)
   break
   case "codetxt":
     if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
